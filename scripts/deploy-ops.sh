...
gcloud run deploy "${SERVICE_NAME}" \
  ...
  --cpu-boost \
  --startup-probe="" \
  --set-env-vars "FOREFLIGHT_MAILBOX=ForeFlight@baker-aviation.com,NMS_BASE_URL=https://api-nms.aim.faa.gov,NMS_AUTH_URL=https://api-nms.aim.faa.gov/v1/auth/token" \
