...
export async function fetchJobs(
  ...
  if (error) {
    ...
    const fallbackCols = JOB_COLUMNS_BASE + ", pipeline_stage, structured_notes, rejected_at, rejection_reason, rejection_type, deleted_at, hr_reviewed, previously_rejected, interview_email_sent_at, offer_status, offer_sent_at, interest_check_sent_at, interest_check_response";
