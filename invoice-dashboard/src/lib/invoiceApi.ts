...
export async function fetchAlerts(params: {
  ...
  for (const row of data ?? []) {
    ...
    alerts.push({
      ...
      vendor: (mp.vendor as string | undefined) || (mp.vendor_name as string | undefined) || fallback?.vendor_name || null,
      tail: (mp.tail as string | undefined) || (mp.tail_number as string | undefined) || fallback?.tail_number || null,
