...
export const SECTIONS = [
  ...
  { key: "pilots", label: "Pilots", paths: ["/pilots"] },
  { key: "aircraft", label: "Aircraft", paths: ["/aircraft"] },
  { key: "integrations", label: "Integrations", paths: ["/integrations", "/hamilton", "/jetinsight"] },
] as const;
