...
const AIRPORTS: Record<string, AirportInfo> = {
  ...
  VIX: { code: "VIX", name: "Vitória/Goiabeiras Intl", lat: -20.2581, lon: -40.2842, city: "Vitória", state: "ES" },
  ...
  YQR: { code: "YQR", name: "Regina International", lat: 50.4319, lon: -104.6659, city: "Regina", state: "SK" },
  ...
  RDM: { code: "RDM", name: "Redmond Municipal", lat: 44.2541, lon: -121.1500, city: "Redmond", state: "OR" },
