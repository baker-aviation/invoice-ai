...
const STAGES: { key: HiringStage; label: string; color: string }[] = [
  ...
  { key: "interview_pre", label: "Pre-Interview", color: "bg-violet-50 border-violet-300" },
  { key: "interview_post", label: "Post-Interview", color: "bg-purple-50 border-purple-300" },
