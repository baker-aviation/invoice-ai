...
import AircraftFuelPlans from "./AircraftFuelPlans";
...
export default function FuelPlanningPage() {
  return (
    <>
      ...
      <Tabs defaultValue="plans" className="px-6 -mt-2">
        <TabsList variant="line" className="mb-4 overflow-x-auto">
          <TabsTrigger value="plans">Aircraft Fuel Plans</TabsTrigger>
          <TabsTrigger value="releases">Fuel Releases</TabsTrigger>
          <TabsTrigger value="admin">Fuel Admin</TabsTrigger>
        </TabsList>

        <TabsContent value="plans"><AircraftFuelPlans /></TabsContent>
        <TabsContent value="releases"><FleetFuelDashboard /></TabsContent>
        <TabsContent value="admin">
          <Tabs defaultValue="fbo" className="mt-2">
            <TabsList variant="line" className="mb-4 overflow-x-auto">
