...
function DetailPanel({
  ...
  initialTab?: "details" | "comments" | "emails" | "pdf";
}) {
  const [tab, setTab] = useState<"details" | "comments" | "emails" | "pdf">(initialTab ?? "details");
...
export default function AlertsTable({
  ...
  const [expandedTab, setExpandedTab] = useState<"details" | "comments" | "emails" | "pdf">("details");
                ...
                return (
                  <tbody key={a.id}>
                    <tr
                      ...
                      onClick={() => { setExpandedId(isExpanded ? null : a.id); setExpandedTab("details"); }}
                    >
                      ...
                      <td className="px-3 py-2.5 text-right whitespace-nowrap" onClick={(e) => e.stopPropagation()}>
                        <div className="flex items-center justify-end gap-2">
                          {pdfUrl && (
                            <button
                              onClick={() => { setExpandedId(isExpanded && expandedTab === "pdf" ? null : a.id); setExpandedTab("pdf"); }}
