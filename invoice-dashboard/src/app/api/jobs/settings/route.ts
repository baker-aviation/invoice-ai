...
export async function PATCH(req: NextRequest) {
  ...
  const ALLOWED_KEYS = ["interview_calendly_url", "interview_email_template", "info_session_meet_link", "info_session_email_template", "rejection_email_soft", "rejection_email_hard", "rejection_email_left"];
